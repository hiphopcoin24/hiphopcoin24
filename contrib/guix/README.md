# Bootstrappable Hiphopcoin Core Builds

This directory contains the files necessary to perform bootstrappable Hiphopcoin
Core builds.
...
- 24GB of free disk space on the partition that the Hiphopcoin Core git repository
  resides in
...
For a Hiphopcoin Core depends development environment, simply invoke
...
From the top of a clean Hiphopcoin Core repository:
...
To use dongcarl's substitute server for Hiphopcoin Core builds after having
