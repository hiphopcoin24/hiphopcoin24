...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the hiphopcoin repository."
  exit 1
fi
...
# See https://github.com/hiphopcoin/hiphopcoin/issues/16064
...
echo 'When compiling hiphopcoind, run `./configure` in the following way:'
echo
