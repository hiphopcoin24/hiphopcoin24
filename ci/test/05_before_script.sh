...
if [ "$CI_OS_NAME" == "macos" ]; then
  echo > $HOME/Library/Application\ Support/Hiphopcoin
else
  DOCKER_EXEC echo \> \$HOME/.hiphopcoin
fi
...
if [[ ${USE_MEMORY_SANITIZER} == "true" ]]; then
  ...
  # from depends. See https://github.com/hiphopcoin/hiphopcoin/pull/18288#discussion_r433189350 for
  # details.
