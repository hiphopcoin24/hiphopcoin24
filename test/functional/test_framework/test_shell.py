...
class TestShell:
    """Wrapper Class for HiphopcoinTestFramework.

    The TestShell class extends the HiphopcoinTestFramework
    ...
    class __TestShell(HiphopcoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by HiphopcoinTestFramework child class.
            self.num_nodes = 1
