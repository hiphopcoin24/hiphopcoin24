...
class P2PPermissionsTests(HiphopcoinTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].hiphopcoinconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].hiphopcoinconf, 'w', encoding="utf8") as f:
            f.write(newText)
