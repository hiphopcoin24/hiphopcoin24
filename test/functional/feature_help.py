...
"""Verify that starting hiphopcoin with -h works as expected."""

from test_framework.test_framework import HiphopcoinTestFramework
from test_framework.util import assert_equal

class HelpTest(HiphopcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start hiphopcoin with -h for help text")
        ...
        self.log.info("Start hiphopcoin with -version for version information")
        ...
        self.log.info("Start hiphopcoind with -fakearg to make sure it does not start")
