...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the HiphopcoinTestFramework
    pass


class ExampleTest(HiphopcoinTestFramework):
    # Each functional test is a subclass of the HiphopcoinTestFramework class.
    ...
    def custom_method(self):
        ...
        HiphopcoinTestFramework class so other tests can use it."""
