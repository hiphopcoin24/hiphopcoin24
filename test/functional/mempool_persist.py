...
By default, hiphopcoind will dump mempool on shutdown and
...
class MempoolPersistTest(HiphopcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent hiphopcoind from writing mempool.dat to disk. Verify that `savemempool` fails")
