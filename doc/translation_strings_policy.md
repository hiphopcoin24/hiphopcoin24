...
This document provides guidelines for internationalization of the Hiphopcoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `hiphopcoin_en.ts` remains unchanged.
