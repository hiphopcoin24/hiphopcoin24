Hiphopcoin Core version *0.15.2* is now available from:

  <https://hiphopcoincore.org/bin/hiphopcoin-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in hiphopcoin-tx (TheBlueMatt)
