Download URL: https://sourceforge.net/projects/hiphopcoin/files/Hiphopcoin/hiphopcoin-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 HPC fee schedule (users still pay 0.01 HPC per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #hiphopcoin00 - #hiphopcoin99
