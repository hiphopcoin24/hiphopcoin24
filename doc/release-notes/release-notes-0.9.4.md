Hiphopcoin Core version 0.9.4 is now available from:

  https://hiphopcoin.org/bin/0.9.4/
...
this update is incompatible with the Hiphopcoin system and could lead to consensus
forks.

Hiphopcoin Core released binaries from https://hiphopcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~hiphopcoin/+archive/ubuntu/hiphopcoin
- A third-party or self-compiled Hiphopcoin Core

upgrade to Hiphopcoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
