Hiphopcoin Core version 0.16.1 is now available from:

  <https://hiphopcoincore.org/bin/hiphopcoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting hiphopcoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure hiphopcoind processes are cleaned up when tests end (sdaftuar)
