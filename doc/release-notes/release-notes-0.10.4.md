Hiphopcoin Core version 0.10.4 is now available from:

  <https://hiphopcoin.org/bin/hiphopcoin-core-0.10.4/>
...
- #6953 `43c2789` Split hiphopcoin-tx into its own package
- #6953 `dfe0d4d` Include hiphopcoin-tx binary on Debian/Ubuntu
