Hiphopcoin Core version 0.13.2 is now available from:

  <https://hiphopcoin.org/bin/hiphopcoin-core-0.13.2/>
...
- #8908 `4a974b2` Update hiphopcoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow hiphopcoin-tx to create v2 transactions (hpcdrak)
