Hiphopcoin Core version 0.9.2.1 is now available from:

  https://hiphopcoin.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 HPC to 0.01 HPC
...
- Fix "Start hiphopcoin on system login"
