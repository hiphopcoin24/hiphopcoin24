Hiphopcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/hiphopcoin/files/Hiphopcoin/hiphopcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Hiphopcoin
...
New/changed settings (command-line or hiphopcoin.conf file)
--------------------------------------------------------
