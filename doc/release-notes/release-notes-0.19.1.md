...
Hiphopcoin Core version 0.19.1 is now available from:

  <https://hiphopcoincore.org/bin/hiphopcoin-core-0.19.1/>
...
From Hiphopcoin Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Hiphopcoin Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Hiphopcoin Core does not yet change appearance when
...
- #17488 fix "hiphopcoind already running" warnings on macOS (fanquake)
