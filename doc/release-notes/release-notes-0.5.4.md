Hiphopcoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/hiphopcoin/files/Hiphopcoin/hiphopcoin-0.5.4/
...
http://gitorious.org/hiphopcoin/hiphopcoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Hiphopcoin-Qt notifications under Growl 1.3.
Increase required age of Hiphopcoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxHiphopcoin properly when installing Hiphopcoin-Qt over it. (Windows)
