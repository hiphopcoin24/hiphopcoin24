Hiphopcoin Core version *0.15.0.1* is now available from:

  <https://hiphopcoin.org/bin/hiphopcoin-core-0.15.0.1/>

and

  <https://hiphopcoincore.org/bin/hiphopcoin-core-0.15.0.1/>
