// Copyright (c) 2015-2018 The Hiphopcoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef HIPHOPCOIN_ZMQ_ZMQABSTRACTNOTIFIER_H
#define HIPHOPCOIN_ZMQ_ZMQABSTRACTNOTIFIER_H
...
#endif // HIPHOPCOIN_ZMQ_ZMQABSTRACTNOTIFIER_H
