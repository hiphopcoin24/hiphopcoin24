...
#ifndef HIPHOPCOIN_WALLET_SCRIPTPUBKEYMAN_H
#define HIPHOPCOIN_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Hiphopcoin Core wallet was originally a collection of unrelated private
...
#endif // HIPHOPCOIN_WALLET_SCRIPTPUBKEYMAN_H
