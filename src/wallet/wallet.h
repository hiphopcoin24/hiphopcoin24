...
#ifndef HIPHOPCOIN_WALLET_WALLET_H
#define HIPHOPCOIN_WALLET_WALLET_H
...
public:
     ...
     * on this hiphopcoin node, and set to 0 for transactions that were created
...
#endif // HIPHOPCOIN_WALLET_WALLET_H
