...
#ifndef HIPHOPCOIN_WALLET_WALLETUTIL_H
#define HIPHOPCOIN_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! hiphopcoin from opening the wallet, thinking it was newly created, and
...
#endif // HIPHOPCOIN_WALLET_WALLETUTIL_H
