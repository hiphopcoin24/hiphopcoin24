    ...
    mapper(nullptr)
{
    ...
    ui->hiphopcoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->hiphopcoinAtStartup);
    ...
    ui->hiphopcoinAtStartup->setToolTip(ui->hiphopcoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->hiphopcoinAtStartup->setText(ui->hiphopcoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openHiphopcoinConfButton->setToolTip(ui->openHiphopcoinConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new HiphopcoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->hiphopcoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openHiphopcoinConfButton_clicked()
{
