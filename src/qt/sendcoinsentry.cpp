    ...
    platformStyle(_platformStyle)
{
    ...
    // normal hiphopcoin address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying hiphopcoin address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &HiphopcoinAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
