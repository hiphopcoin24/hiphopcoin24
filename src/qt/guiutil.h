...
#ifndef HIPHOPCOIN_QT_GUIUTIL_H
#define HIPHOPCOIN_QT_GUIUTIL_H
...
/** Utility functions used by the Hiphopcoin Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "hiphopcoin:" URI into recipient object, return true on successful parsing
