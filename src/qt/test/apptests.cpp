...
//! Entry point for HiphopcoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &HiphopcoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for HiphopcoinGUI tests.
void AppTests::guiTests(HiphopcoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &HiphopcoinGUI::consoleShown, this, &AppTests::consoleTests);
