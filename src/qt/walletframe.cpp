...
WalletFrame::WalletFrame(const PlatformStyle* _platformStyle, HiphopcoinGUI* _gui)
    : QFrame(_gui),
      gui(_gui),
...
bool WalletFrame::addWallet(WalletModel *walletModel)
{
    ...
    connect(walletView, &WalletView::transactionClicked, gui, &HiphopcoinGUI::gotoHistoryPage);
    connect(walletView, &WalletView::coinsSent, gui, &HiphopcoinGUI::gotoHistoryPage);
    connect(walletView, &WalletView::message, [this](const QString& title, const QString& message, unsigned int style) {
        gui->message(title, message, style);
    });
    connect(walletView, &WalletView::encryptionStatusChanged, gui, &HiphopcoinGUI::updateWalletStatus);
    connect(walletView, &WalletView::incomingTransaction, gui, &HiphopcoinGUI::incomingTransaction);
    connect(walletView, &WalletView::hdEnabledStatusChanged, gui, &HiphopcoinGUI::updateWalletStatus);
    connect(gui, &HiphopcoinGUI::setPrivacy, walletView, &WalletView::setPrivacy);
