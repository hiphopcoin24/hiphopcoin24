...
#ifndef HIPHOPCOIN_TEST_SCRIPTNUM10_H
#define HIPHOPCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Hiphopcoin Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // HIPHOPCOIN_TEST_BIGNUM_H
