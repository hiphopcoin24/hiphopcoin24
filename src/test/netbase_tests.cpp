...
{
    BOOST_CHECK(TestSplitHost("www.hiphopcoincore.org", "www.hiphopcoincore.org", -1));
    BOOST_CHECK(TestSplitHost("[www.hiphopcoincore.org]", "www.hiphopcoincore.org", -1));
    BOOST_CHECK(TestSplitHost("www.hiphopcoincore.org:80", "www.hiphopcoincore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.hiphopcoincore.org]:80", "www.hiphopcoincore.org", 80));
