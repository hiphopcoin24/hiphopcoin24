...
static void SetupHiphopcoinTxArgs(ArgsManager &argsman)
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " hiphopcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  hiphopcoin-tx [options] <hex-tx> [commands]  Update hex-encoded hiphopcoin transaction\n" +
            "or:     hiphopcoin-tx [options] -create [commands]   Create hex-encoded hiphopcoin transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded hiphopcoin transaction
