...
#ifndef HIPHOPCOIN_COMPAT_ASSUMPTIONS_H
#define HIPHOPCOIN_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "Hiphopcoin cannot be compiled without assertions."
#endif
...
#endif // HIPHOPCOIN_COMPAT_ASSUMPTIONS_H
