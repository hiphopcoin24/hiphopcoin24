...
#ifndef HIPHOPCOIN_CHAINPARAMSBASE_H
#define HIPHOPCOIN_CHAINPARAMSBASE_H
...
/**
 * CBaseChainParams defines the base parameters (shared between hiphopcoin-cli and hiphopcoind)
 * of a given instance of the Hiphopcoin system.
 */
...
#endif // HIPHOPCOIN_CHAINPARAMSBASE_H
