...
#ifndef HIPHOPCOIN_CRYPTO_CHACHA_POLY_AEAD_H
#define HIPHOPCOIN_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@hiphopcoin.
 *
 ...
 *
 * The chacha20-poly1305@hiphopcoin combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@hiphopcoin cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@hiphopcoin are relatively fast in
...
#endif // HIPHOPCOIN_CRYPTO_CHACHA_POLY_AEAD_H
