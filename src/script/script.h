...
#ifndef HIPHOPCOIN_SCRIPT_SCRIPT_H
#define HIPHOPCOIN_SCRIPT_SCRIPT_H
...
public:
    ...
    /**
     * Pre-version-0.6, Hiphopcoin always counted CHECKMULTISIGs
...
#endif // HIPHOPCOIN_SCRIPT_SCRIPT_H
