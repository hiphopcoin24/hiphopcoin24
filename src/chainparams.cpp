...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed.hiphopcoin.sipa.be"); // Pieter Wuille, only supports x1, x5, x9, and xd
        vSeeds.emplace_back("dnsseed.bluematt.me"); // Matt Corallo, only supports x9
        vSeeds.emplace_back("dnsseed.hiphopcoin.dashjr.org"); // Luke Dashjr
        vSeeds.emplace_back("seed.hiphopcoinstats.com"); // Christian Decker, supports x1 - xf
        vSeeds.emplace_back("seed.hiphopcoin.jonasschnelli.ch"); // Jonas Schnelli, only supports x1, x5, x9, and xd
        vSeeds.emplace_back("seed.hpc.petertodd.org"); // Peter Todd, only supports x1, x5, x9, and xd
        vSeeds.emplace_back("seed.hiphopcoin.sprovoost.nl"); // Sjors Provoost
        vSeeds.emplace_back("dnsseed.emzy.de"); // Stephan Oeste
        vSeeds.emplace_back("seed.hiphopcoin.wiz.biz"); // Jason Maurice
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.hiphopcoin.jonasschnelli.ch");
        vSeeds.emplace_back("seed.thpc.petertodd.org");
        vSeeds.emplace_back("seed.testnet.hiphopcoin.sprovoost.nl");
