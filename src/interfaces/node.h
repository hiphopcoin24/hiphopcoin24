...
#ifndef HIPHOPCOIN_INTERFACES_NODE_H
#define HIPHOPCOIN_INTERFACES_NODE_H
...
//! Top-level interface for a hiphopcoin node (hiphopcoind process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // HIPHOPCOIN_INTERFACES_NODE_H
