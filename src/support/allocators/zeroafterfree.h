...
#ifndef HIPHOPCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define HIPHOPCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // HIPHOPCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
