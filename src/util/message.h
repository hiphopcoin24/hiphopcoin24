...
#ifndef HIPHOPCOIN_UTIL_MESSAGE_H
#define HIPHOPCOIN_UTIL_MESSAGE_H
 ...
 * @param[in] address Signer's hiphopcoin address, it must refer to a public key.
...
#endif // HIPHOPCOIN_UTIL_MESSAGE_H
