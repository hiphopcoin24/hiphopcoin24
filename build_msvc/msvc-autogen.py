...
libs = [
    'libhiphopcoin_cli',
    'libhiphopcoin_common',
    'libhiphopcoin_crypto',
    'libhiphopcoin_server',
    'libhiphopcoin_util',
    'libhiphopcoin_wallet_tool',
    'libhiphopcoin_wallet',
    'libhiphopcoin_zmq',
    'bench_hiphopcoin',
    'libtest_util',
]
...
def main():
    parser = argparse.ArgumentParser(description='Hiphopcoin-core msbuild configuration initialiser.')
        ...
        with open(vcxproj_filename + '.in', 'r', encoding='utf-8') as vcxproj_in_file:
            with open(vcxproj_filename, 'w', encoding='utf-8') as vcxproj_file:
                vcxproj_file.write(vcxproj_in_file.read().replace(
                    '@SOURCE_FILES@\n', content))
    copyfile(os.path.join(SOURCE_DIR,'../build_msvc/hiphopcoin_config.h'), os.path.join(SOURCE_DIR, 'config/hiphopcoin-config.h'))
