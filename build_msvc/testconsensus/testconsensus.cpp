...
// hiphopcoin includes.
#include <..\src\script\hiphopcoinconsensus.h>
...
int main()
{
    std::cout << "hiphopcoinconsensus version: " << hiphopcoinconsensus_version() << std::endl;
    ...
    auto op0Result = hiphopcoinconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, (const unsigned char*)&stream[0], stream.size(), 0, hiphopcoinconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
